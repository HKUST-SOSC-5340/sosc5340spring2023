...
- case 2: we create 100 surveys, each of size 1000, from the population. Plot color is green.
- case 3: we create 1000 surveys, each of size 1000, from the population. Plot color is blue.
...
for (i in 1:100){
  ...
  boot_data <- sample(sample, length(sample), replace = T)
